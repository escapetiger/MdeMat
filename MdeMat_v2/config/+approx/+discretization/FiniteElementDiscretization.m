classdef FiniteElementDiscretization < handle
    ...
    %
    % See also:
    %   approx.element.L2Element, approx.element.L2ElementOperator,
    ...
    methods
        ...
        function obj = setDgOrthotopeElement(obj, varargin)
            ...
            obj.element = approx.element.L2Element(G, P, VI, FI);
        end
        ...
        function obj = setElementOperator(obj)
            ...
            switch class(obj.element)
                ...
                case 'approx.element.L2Element'
                    obj.operator = approx.element.L2ElementOperator(obj.element);
            end
        end
...
%             if isa(obj.element, 'approx.element.L2Element')
...
%             if isa(obj.operator, 'approx.element.L2ElementOperator')
