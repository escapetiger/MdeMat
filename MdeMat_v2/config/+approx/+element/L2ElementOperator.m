classdef L2ElementOperator < approx.element.C0ElementOperator
    % DGELEMENTOPERATOR Operator for discontinuous finite elements.
    %
    %   L2ElementOperator extends C0 operators with flux contributions
    ...
    %   operator = L2ElementOperator(element);
    %
    ...
    %
    % See also:
    %   approx.element.C0ElementOperator, approx.element.L2Element,
    ...
    methods
        function obj = L2ElementOperator(element)
            % DGELEMENTOPERATOR Constructor for L2ElementOperator.
            %
            %   obj = L2ElementOperator(element) creates an operator for
            %   the specified DG element. The element must be an L2Element
            ...
            %
            % Outputs:
            %   obj - Constructed L2ElementOperator object
        ...
        function obj = setFluxData(obj)
            ...
            %
            % Inputs:
            %   obj - The L2ElementOperator object
            %
            % Outputs:
            %   obj - The L2ElementOperator object
