classdef DgElementClipper < approx.element.C0ElementClipper
    % DGELEMENTCLIPPER Geometric clipper for DG elements.
    %
    %   DgElementClipper extends the C0 clipper with flux piece
    ...
    %   clipper = DgElementClipper(element, velocity);
    %   
    ...
    %
    % See also:
    %   approx.element.C0ElementClipper, approx.element.DgElement,
    ...
    methods
        function obj = setFluxPieceData(obj, ht, hx)
            ...
            %
            % Inputs:
            %   obj - The DgElementClipper object
