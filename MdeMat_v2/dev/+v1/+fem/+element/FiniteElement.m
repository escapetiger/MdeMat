classdef FiniteElement < handle
    ...
    properties (Dependent)
        nDims % Number of spatial dimensions (dependent property)
        nDofs % Number of degrees of freedom (dependent property)
        outerNormals % Outer normal vectors at geometry boundaries (dependent property)
    end
    ...
    methods
        ...
        function N = get.outerNormals(obj)
            % GET.OUTERNORMALS Get outer normal vectors at geometry boundaries.
            %
