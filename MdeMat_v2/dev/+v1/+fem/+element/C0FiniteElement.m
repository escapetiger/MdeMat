classdef C0FiniteElement < fem.element.FiniteElement
    ...
    methods
        function obj = C0FiniteElement(K, P, I)
            ...
            obj.volumeData = fem.data.FunctionData(I);
        end
                
        function setVolumeData(obj, r, varargin)
            % SETVOLUMEDATA Set function data for volume integrals.
            %
            %   setVolumeData(obj, r) computes and stores function values
            %   and derivatives up to order r at integration points for use
            %   in volume integral computations. This pre-computation
            %   enables efficient assembly of bilinear forms.
            %
            %   setVolumeData(obj, r, args) allows additional arguments
            %   to be passed to the integration point setup.
            %
            % Inputs:
