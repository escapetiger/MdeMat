classdef L2FiniteElement < fem.element.C0FiniteElement
    ...
    methods
        function obj = L2FiniteElement(K, P, I1, I2)
            ...
            obj.fluxData = arrayfun(@(I) fem.element.FunctionData(I), I2);
        end
        ...
        function obj = setFluxData(obj, r, varargin)
            % SETFLUXDATA Set function data for flux integrals.
            %
            %   obj = setFluxData(obj, r) computes and stores function
            %   values and derivatives up to order r at boundary
            %   integration points for all element faces. This enables
            %   efficient computation of flux terms in discontinuous
            %   Galerkin formulations.
            %
            %   obj = setFluxData(obj, r, integrationArgs) allows
            %   additional arguments to be passed to the integration point
            %   setup.
            %
            % Inputs:
            %   obj - The L2FiniteElement object
