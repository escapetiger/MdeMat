classdef TestLineSegmentByPlaneIntersector < matlab.unittest.TestCase
    % TESTLINESEGMENTBYPLANEINTERSECTOR Tests for LineSegmentByPlaneIntersector.
    %
    ...
    methods (Test)
        function testConstructor(testCase)
            intersector = core.geometry.LineSegmentByPlaneIntersector(2);
            testCase.verifyEqual(intersector.nDims, 2);
            
            intersector = core.geometry.LineSegmentByPlaneIntersector(3);
            testCase.verifyEqual(intersector.nDims, 3);
            
            testCase.verifyError(@() core.geometry.LineSegmentByPlaneIntersector(1), ...
                'core:geometry:LineSegmentByPlaneIntersector:InvalidInput');
        end
        ...
        function testHigherDimension(testCase)
            ...
            intersector = core.geometry.LineSegmentByPlaneIntersector(4);
        ...
        function testDimensionMismatch(testCase)
            ...
            testCase.verifyError(@() intersector.intersect(X1, X2, a, b), ...
                'core:geometry:LineSegmentByPlaneIntersector:DimensionMismatch');
        end
