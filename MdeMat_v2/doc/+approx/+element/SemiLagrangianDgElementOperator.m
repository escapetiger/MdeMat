classdef SemiLagrangianDgElementOperator < approx.element.SemiLagrangianC0ElementOperator
    % SEMILAGRANGIANDGELEMENTOPERATOR Semi-Lagrangian operator for
    % discontinuous finite elements.
    %
    %   SemiLagrangianDgElementOperator extends the C0 semi-Lagrangian
    ...
    methods
        function obj = SemiLagrangianDgElementOperator(element, clipper)
            % DGSEMILAGRANGIANELEMENTOPERATOR Constructor for
            % SemiLagrangianDgElementOperator.
            %
            %   obj = SemiLagrangianDgElementOperator(element, clipper)
            ...
            %
            % Outputs:
            %   obj - Constructed SemiLagrangianDgElementOperator object
        ...
        function obj = setFluxPieceData(obj)
            ...
            %
            % Inputs:
            %   obj - The SemiLagrangianDgElementOperator object
            %
            % Outputs:
            %   obj - The SemiLagrangianDgElementOperator object
