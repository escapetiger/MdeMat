classdef FiniteElementMultiplierAssembly < approx.assembly.FiniteElementAssembly
    % FINITEELEMENTMULTIPLIERASSEMBLY Assembly for finite element
    % multipliers.
    %
    %   FiniteElementMultiplierAssembly provides functionality for
    ...
    methods
        function G = assembleMatrix(obj, field, options)
            ...
            arguments
                obj approx.assembly.FiniteElementMultiplierAssembly
