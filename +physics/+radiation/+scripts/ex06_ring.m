...
% Author: Yi CAI
% Description:
%   Ring-shaped initial distribution test for radiation transport. An
%   isotropic ring density profile propagates through a pure scattering
%   medium.
%==========================================================================
...
for k = 1:length(epsilon)
    ...
    switch config.id
        case 'ex06_2dt'
            config.ckptPrefix = strjoin({'RING2DT', config.ckptPrefix}, '_');
    end
