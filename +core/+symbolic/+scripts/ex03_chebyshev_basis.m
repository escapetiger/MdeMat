%% EX03_CHEBYSHEV_BASIS Generate Chebyshev orthogonal basis functions.
%
%   This script generates Chebyshev polynomial basis functions of the first 
%   kind up to a specified maximum degree. Configure parameters below and 
%   run the script.
...
fileName = '+core/+symbolic/metadata/chebyshev'; % Save file name
maxDerivOrder = maxDegree; % Maximum derivative order for compilation

%% Generate Chebyshev Basis Functions

basis = core.symbolic.ChebyshevBasis(variable, maxDegree, ...
