classdef SemiLagrangianAssembly < approx.assembly.FiniteElementAssembly
    % FINITEELEMENTSEMILAGRANGIANASSEMBLY Assembly for semi-Lagrangian finite element methods.
    %
    %   SemiLagrangianAssembly implements assembly operations for
    ...
    methods
        function obj = SemiLagrangianAssembly(space, bcType)
            % FINITEELEMENTSEMILAGRANGIANASSEMBLY Constructor for semi-Lagrangian assembly.
            %
            %   obj = SemiLagrangianAssembly(space, bcType) creates
        ...
        function obj = setBcType(obj, bcType)
            ...
            arguments
                obj approx.assembly.SemiLagrangianAssembly
                bcType {mustBeMember(bcType, {'periodic', 'dirichlet'})}
            end
